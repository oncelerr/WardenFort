...
#include "../../WardenFort/animatedlabel.h"
...
static constexpr auto qt_meta_stringdata_CLASSAnimatedLabelENDCLASS = QtMocHelpers::stringData(
    "AnimatedLabel",
    "clicked",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSAnimatedLabelENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSAnimatedLabelENDCLASS_t qt_meta_stringdata_CLASSAnimatedLabelENDCLASS = {
    {
        QT_MOC_LITERAL(0, 13),  // "AnimatedLabel"
...
void AnimatedLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &AnimatedLabel::clicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
