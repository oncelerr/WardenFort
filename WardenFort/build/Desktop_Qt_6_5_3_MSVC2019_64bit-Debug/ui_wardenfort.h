...
"border-bottom-left-radius: 10px;"));
        ...
        frame_3->setGeometry(QRect(570, 20, 180, 106));
...
"color: rgb(255, 255, 255);"));
        ...
        tableWidget->setGeometry(QRect(270, 150, 801, 391));
...
"}"));
        ...
        frame_4->setGeometry(QRect(890, 20, 180, 106));
...
"border-radius: 10px;"));
        ...
        label_7->setGeometry(QRect(0, 0, 181, 111));
        label_7->setStyleSheet(QString::fromUtf8("QLabel {\n"
"	background-color: rgba(255, 255, 255, 0);\n"
"    border-radius: 10px; /* Adjust the value as per your preference */\n"
"}"));
        label_7->setPixmap(QPixmap(QString::fromUtf8(":/wardenfort/wave (3).png")));
        overallAlert = new QLabel(frame_4);
        overallAlert->setObjectName("overallAlert");
        overallAlert->setGeometry(QRect(0, 40, 181, 41));
...
"color: rgb(255, 255, 255);"));
        ...
        frame_8->setGeometry(QRect(270, 20, 180, 106));
...
"border-radius: 10px;"));
        ...
        label_12->setGeometry(QRect(0, 0, 211, 111));
        label_12->setStyleSheet(QString::fromUtf8("QLabel {\n"
"	background-color: rgba(255, 255, 255, 0);\n"
"    border-radius: 10px; /* Adjust the value as per your preference */\n"
"}"));
        label_12->setPixmap(QPixmap(QString::fromUtf8(":/wardenfort/wave (1).png")));
...
"color: rgb(255, 255, 255);"));
        ...
        trafficAnomalies->setGeometry(QRect(0, 40, 181, 41));
...
"}"));
    ...
    void retranslateUi(QMainWindow *WardenFort)
    {
        ...
        welcome_text->setText(QCoreApplication::translate("WardenFort", "Welcome, User!", nullptr));
